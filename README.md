...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/uhi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12233&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/uhi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `uhi` can be installed with:

```
conda install uhi
```

It is possible to list all of the versions of `uhi` available on your platform with:
